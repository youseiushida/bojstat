...
from bojstat.enums import ConsistencyMode as ConsistencyMode, DB as DB, Format as Format, Lang as Lang, OutputOrder as OutputOrder
...
class DataService:
    ...
    def get_by_code(self, *, db: DB | str, code: str | Sequence[str], start: str | None = None, end: str | None = None, start_position: int | None = None, lang: Lang | str | None = None, format: Format | str | None = None, strict_api: bool | None = None, auto_split_codes: bool | None = None, raw_params: Mapping[str, str] | None = None, resume_token: str | None = None, output_order: OutputOrder | str | None = None) -> TimeSeriesFrame:
        """コードAPIで時系列データを取得する。"""
    def get_by_layer(self, *, db: DB | str, frequency: str, layer: str | Sequence[str | int], start: str | None = None, end: str | None = None, start_position: int | None = None, lang: Lang | str | None = None, format: Format | str | None = None, auto_paginate: bool = True, raw_params: Mapping[str, str] | None = None, resume_token: str | None = None) -> TimeSeriesFrame:
        """階層APIで時系列データを取得する。"""
