...
from bojstat.enums import ConsistencyMode as ConsistencyMode, DB as DB, Format as Format, Frequency as Frequency, Lang as Lang, OutputOrder as OutputOrder
from bojstat.errors import BojConsistencyError as BojConsistencyError, BojDateParseError as BojDateParseError
from bojstat.models import MetadataFrame as MetadataFrame, TimeSeriesFrame as TimeSeriesFrame
...
from bojstat.validation import canonical_params as canonical_params, guess_frequency_from_code as guess_frequency_from_code, normalize_code_periods as normalize_code_periods, normalize_codes as normalize_codes, normalize_db as normalize_db, normalize_format as normalize_format, normalize_frequency as normalize_frequency, normalize_lang as normalize_lang, normalize_layer as normalize_layer, normalize_periods as normalize_periods, normalize_raw_params as normalize_raw_params, split_codes_by_frequency_and_size as split_codes_by_frequency_and_size, validate_strict_auto_split as validate_strict_auto_split
from collections.abc import Mapping, Sequence
from typing import Any

class DataService:
    """同期データ取得サービス。"""
    def __init__(self, *, client: httpx.Client, config: ClientConfig, retry_config: RetryConfig, cache: FileCache, limiter: Any, metadata_service: Any = None) -> None: ...
    def get_by_code(self, *, db: DB | str, code: str | Sequence[str], start: str | None = None, end: str | None = None, start_position: int | None = None, lang: Lang | str | None = None, format: Format | str | None = None, strict_api: bool | None = None, auto_split_codes: bool | None = None, raw_params: Mapping[str, str] | None = None, resume_token: str | None = None, output_order: OutputOrder | str | None = None) -> TimeSeriesFrame:
        """コードAPIで時系列データを取得する。"""
    def get_by_layer(self, *, db: DB | str, frequency: str, layer: str | Sequence[str | int], start: str | None = None, end: str | None = None, start_position: int | None = None, lang: Lang | str | None = None, format: Format | str | None = None, auto_paginate: bool = True, raw_params: Mapping[str, str] | None = None, resume_token: str | None = None, resolve_wildcard: bool | None = None) -> TimeSeriesFrame:
        """階層APIで時系列データを取得する。"""

class AsyncDataService:
    """非同期データ取得サービス。"""
    def __init__(self, *, client: httpx.AsyncClient, config: ClientConfig, retry_config: RetryConfig, cache: FileCache, limiter: Any, metadata_service: Any = None) -> None: ...
