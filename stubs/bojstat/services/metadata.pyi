...
from bojstat.enums import DB as DB, Format as Format, Lang as Lang
...
class MetadataService:
    ...
    def get(self, *, db: DB | str, lang: Lang | str | None = None, format: Format | str | None = None, raw_params: dict[str, str] | None = None) -> MetadataFrame:
        """メタデータAPIで取得する。"""
...
class AsyncMetadataService:
    ...
    async def get(self, *, db: DB | str, lang: Lang | str | None = None, format: Format | str | None = None, raw_params: dict[str, str] | None = None) -> MetadataFrame:
        """メタデータAPIで取得する。"""
